...
from django.core.management.base import BaseCommand as BaseCommandBase


class EnhancedCommand(BaseCommandBase):
    """
    Base class for enhanced commands.
    ...
    def create_parser(self, prog_name, subcommand):
        ...
        """
        parser = super(EnhancedCommand, self).create_parser(prog_name, subcommand)
...
class BaseCommandMixin(object):
    ...
    """
    option_list = BaseCommandBase.option_list
    option_groups = (
        ("[standard options]",
            "Standard Django management command options.",
            option_list,
...
class BaseCommand(BaseCommandMixin, EnhancedCommand):
    """
...
class QuietCommand(QuietCommandMixin, EnhancedCommand):
    """
...
class StandardCommand(BaseCommand, QuietCommand, EnhancedCommand):
    """
